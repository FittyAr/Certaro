...
All notable changes to ElectroObra will be documented in this file.
...
First public release. Complete rewrite of ElectroObraApp from C#/Avalonia to Rust/Tauri/Vue.
