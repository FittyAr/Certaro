...
use eo_application::ports::repositories::{ObraConResumen, ObraFiltro, ObraRepository, SortDir};
use eo_application::{AppError, AppResult, PageRequest, PagedResult};
use eo_domain::entities::{Obra, Trabajo};
use eo_domain::{time, EstadoObra, EstadoTrabajo, Money, RowVersion};
