...
pub fn liquidacion(
    ...
    bruto: &str,
    monto_adelanto: &str,
) -> eo_application::dtos::liquidaciones::LiquidacionDetalle {
    use eo_application::dtos::liquidaciones::{LiquidacionAdelantoDto, LiquidacionDetalle};
...
pub fn certificado(
    ...
    ajuste_pct: &str,
    otros: &str,
) -> eo_application::dtos::certificados::CertificadoDetalle {
    use eo_application::dtos::certificados::{CertificadoDetalle, CertificadoItemDto};
...
fn auditoria() -> eo_application::dtos::AuditDto {
    eo_application::dtos::AuditDto {
        created_at: instante(),
        updated_at: None,
        row_version: "0000000000000001".to_owned(),
        is_deleted: false,
