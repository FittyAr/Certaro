...
use certaro_application::dtos::movimientos::MovimientoListItem;
use certaro_application::dtos::reportes::FiltroDescripcion;
...
pub enum Cell {
    ...
    Money(certaro_domain::Money),
    Quantity(certaro_domain::Decimal4),
}
