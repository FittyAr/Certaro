...
use certaro_application::dtos::reportes::{GeneratedReport, ReporteMovimientos};
...
mod tests {
    ...
    fn pdf_movimientos_dice_que_filtros_aplico() {
        ...
        data.filtros_descripcion = vec![certaro_application::dtos::reportes::FiltroDescripcion {
