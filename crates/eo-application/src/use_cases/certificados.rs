...
use eo_domain::entities::{Audit, Certificado, CertificadoItem, OrdenTrabajo};
...
) -> AppResult<Vec<(&'a eo_domain::OrdenTrabajoItem, Decimal4)>> {
...
fn verificar_acumulados(
    avances: &[(&eo_domain::OrdenTrabajoItem, Decimal4)],
...
mod tests {
    ...
    use eo_domain::entities::OrdenTrabajoItem;
