...
pub struct OrdenTrabajoListItem {
    ...
    pub proyecto_numero: Option<i32>,
...
impl OrdenTrabajoListItem {
    pub fn build(row: &OrdenTrabajoConRelaciones) -> AppResult<Self> {
        Ok(Self {
            ...
            trabajo_descripcion: Some(row.trabajo_descripcion.clone()),
            proyecto_id: Some(row.proyecto_id),
            proyecto_numero: Some(row.proyecto_numero),
            proyecto_nombre: Some(row.proyecto_nombre.clone()),
            cliente_id: Some(row.cliente_id),
            cliente_nombre: Some(row.cliente_nombre.clone()),
