...
| :--- | :--- | :---: | :---: | :---: |
| **Fase 1** | Correcciones Críticas de Lógica y Bloqueos de Flujo | 4 | 0 | 🟡 Pendiente |
| **Fase 2** | Integración del Libro de Caja y Rentabilidad de Obras | 4 | 0 | 🟡 Pendiente |
| **Fase 3** | Experiencia de Documentos y Acciones Contextuales | 3 | 0 | 🟡 Pendiente |
| **Fase 4** | Estandarización de UX/UI, Calendario y Onboarding | 4 | 0 | 🟡 Pendiente |
| **Fase 5** | Pruebas Integrales y Verificación de Flujo End-to-End | 3 | 0 | 🟡 Pendiente |

---

## Fase 1: Correcciones Críticas de Lógica y Bloqueos de Flujo

- [ ] **1.1. Selector de Empleado para Adelantos en Movimientos**
...
- [ ] **1.2. Corrección del Bug de Recargos en Liquidaciones por Lote**
...
- [ ] **1.3. Corrección de Mapeo de Columnas en Árbol de Obras (`ProyectosTreeTable`)**
...
- [ ] **1.4. Corrección del Desfasaje Horario (Timezone Bug) en Calendario**
...
- [ ] **2.1. Selector de Cliente, Proyecto y Trabajo en Formulario de Movimientos**
...
- [ ] **2.2. Verificación de Rentabilidad y Caja de Proyecto**
...
- [ ] **2.3. Alta Rápida de Movimiento desde Caja de Proyecto**
...
- [ ] **2.4. Automatización / Vinculación de Cobranzas de Facturas con Caja**
...
- [ ] **3.1. Botón de Descarga / Exportación Directa de Recibo en Liquidación**
...
- [ ] **3.2. Botón de Exportación Directa en Certificado de Avance**
...
- [ ] **3.3. Trazabilidad de Certificado a Factura**
...
- [ ] **4.1. Navegación y Acceso al Detalle de Proyecto**
...
- [ ] **4.2. Refactorización de Componentes en Módulo Calendario**
  - **Archivos:** `src/views/calendario/CalendarioView.vue`.
...
- [ ] **4.3. Flujo de Bienvenida y Onboarding para Usuarios Nuevos**
...
- [ ] **4.4. Acciones Rápidas en Ficha de Cliente**
...
- [ ] **5.3. Prueba de Humo de Flujo de Negocio Completo (Manual)**
